                ...
                <!-- GROUPS SECTION-->
                        <div class="col-sm-11">
                            ...
                            <div class="tbtrack" id="Groups">
                                ...
                                <table id="GroupTable" class="table table-striped table-bordered table-sm" cellspacing="0" width="50%">
                                    <col style="width:10%">
                                    <col style="width:5%">
                                    <col style="widows:85%">
                <!-- Style and Script aren't working.-->
                                    <style>
